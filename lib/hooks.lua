...
function G.UIDEF.use_and_sell_buttons(card)
    ...
    if card.area == G.pack_cards and G.pack_cards and not card.config.center.no_select and ((card.ability.set == "RCode" or card.ability.set == "CBlind" or card.ability.set == "RTarot" or card.ability.set == "RSpectral") or not SMODS.OPENED_BOOSTER.draw_hand and card.children.front) and (card.ability.consumeable) then
        return {
            n = G.UIT.ROOT,
