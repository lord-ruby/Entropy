...
function modsCollectionTally(pool, set)
    if SMODS.ConsumableType and SMODS.ConsumableType.obj_table and SMODS.ConsumableType.obj_table[set] and SMODS.ConsumableType.obj_table[set].hidden then return 0 end
...
G.UIDEF.consumable_collection_page = function(page)
    ...
    if G.ACTIVE_MOD_UI then
        for _, v in ipairs(SMODS.ConsumableType.ctype_buffer) do
            if SMODS.ConsumableType and SMODS.ConsumableType.obj_table and SMODS.ConsumableType.obj_table[v] and SMODS.ConsumableType.obj_table[v].hidden then
