...
SMODS.Stake{
    ...
    modifiers = function()
        ...
        G.GAME.entr_ante_8_boss = localize{type="name_text", set="Blind", key = "bl_entr_brimstone"}
        G.GAME.entr_ante_12_boss = localize{type="name_text", set="Blind", key = "bl_entr_brimstone"}
        G.E_MANAGER:add_event(Event{
            func = function()
                ease_ante(15)
