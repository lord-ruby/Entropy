...
local segfault = {
    ...
    use = function(self, card, area, copier)
        ...
        SMODS.change_base(_card,pseudorandom_element({"Spades","Hearts","Clubs","Diamonds"}, pseudoseed("segfault")),pseudorandom_element({"2", "3", "4", "5", "6", "7", "8", "9", "10", "Ace", "King", "Queen", "Jack"}, pseudoseed("segfault")), nil)
