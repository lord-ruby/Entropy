...
vec4 effect( vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords )
{
    ...
    number fac = 0.8 + 0.9*sin(13.*uv.x+5.32*uv.y + gilded.r*12. + cos(gilded.r*5.3 + uv.y*4.2 - uv.x*4.));
    number fac2 = 0.5 + 0.5*sin(10.*uv.x+2.32*uv.y + gilded.r*5. - cos(gilded.r*2.3 + uv.x*8.2));
    number fac3 = 0.5 + 0.5*sin(12.*uv.x+6.32*uv.y + gilded.r*6.111 + sin(gilded.r*5.3 + uv.y*3.2));
    number fac4 = 0.5 + 0.5*sin(4.*uv.x+2.32*uv.y + gilded.r*8.111 + sin(gilded.r*1.3 + uv.y*13.2));
    number fac5 = sin(0.5*16.*uv.x+5.32*uv.y + gilded.r*12. + cos(gilded.r*5.3 + uv.y*4.2 - uv.x*4.));
